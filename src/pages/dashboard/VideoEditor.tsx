    ...
    <div className="flex flex-col gap-6 h-[calc(100vh-8rem)] lg:h-[calc(100vh-6rem)] overflow-y-auto lg:overflow-hidden pb-10 lg:pb-0">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 overflow-visible lg:overflow-hidden">
        ...
        <div className="flex-1 flex flex-col gap-6 min-h-0 lg:overflow-hidden">
          ...
          {/* Timeline */}
          <div className="h-64 shrink-0 bg-neutral-900/40 backdrop-blur-2xl rounded-[2.5rem] border border-white/5 p-8 flex flex-col overflow-x-auto shadow-2xl">
            <div className="min-w-[800px] flex-1 flex flex-col">
              ...
              <div className="flex-1 relative">
                {/* Time markers */}
                <div className="h-8 border-b border-white/5 flex items-end px-4 mb-4">
                  {[...Array(15)].map((_, i) => (
                    <div key={i} className="flex-1 border-l border-white/10 h-3 text-[9px] font-black font-mono text-neutral-600 pl-2">
                      00:{i < 10 ? `0${i}` : i}
                    </div>
                  ))}
                </div>
                ...
                <div className="space-y-4">
                  <div className="h-12 bg-indigo-500/5 rounded-2xl border border-indigo-500/10 relative flex items-center px-4 group">
                    <Video className="w-4 h-4 text-indigo-400 mr-3 shrink-0" />
                    <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Source Stream</span>
                    <div className="absolute inset-y-2 left-[10%] right-[20%] bg-indigo-500/20 rounded-xl border border-indigo-500/30 shadow-[0_0_10px_rgba(99,102,241,0.1)] group-hover:bg-indigo-500/30 transition-all" />
                  </div>
                  <div className="h-12 bg-purple-500/5 rounded-2xl border border-purple-500/10 relative flex items-center px-4 group">
                    <Type className="w-4 h-4 text-purple-400 mr-3 shrink-0" />
                    <span className="text-[10px] font-black text-purple-400 uppercase tracking-widest">Captions</span>
                    <div className="absolute inset-y-2 left-[15%] right-[25%] bg-purple-500/20 rounded-xl border border-purple-500/30 shadow-[0_0_10px_rgba(168,85,247,0.1)] group-hover:bg-purple-500/30 transition-all" />
                  </div>
                </div>
                
                {/* Playhead */}
                <div className="absolute top-0 bottom-0 left-1/3 w-0.5 bg-white z-10 shadow-[0_0_10px_rgba(255,255,255,0.5)]">
                  <div className="absolute -top-3 -translate-x-1/2 w-4 h-4 rotate-45 bg-white rounded shadow-lg" />
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Sidebar Tools */}
        <div className="w-full lg:w-96 shrink-0 bg-neutral-900/40 backdrop-blur-2xl rounded-[2.5rem] border border-white/5 flex flex-col overflow-hidden min-h-[400px] lg:h-full lg:min-h-0 shadow-2xl">
